...
function TabsV2({ className, ...props }: TabsPrimitive.Root.Props) {
  return (
    <TabsPrimitive.Root
...
function TabsTabV2({ className, ...props }: TabsPrimitive.Tab.Props) {
  return (
    <TabsPrimitive.Tab
      className={cn(
...
function TabsPanelV2({ className, ...props }: TabsPrimitive.Panel.Props) {
  return (
    <TabsPrimitive.Panel
...
export {
  ...
  TabsListV2,
  TabsTabV2,
  TabsTabV2 as TabsTrigger,
  TabsPanelV2,
  TabsPanelV2 as TabsContent,
};
